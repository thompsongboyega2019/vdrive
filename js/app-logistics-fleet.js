(() => {
  mapboxgl.accessToken =
    "pk.eyJ1IjoidGhvbXBzb24yMDI1IiwiYSI6ImNtOG5ibmw1dzBhNm8yanF6aHpvNTA0ZjQifQ.h7Q6PaMPTxFZ60iNxEbHuQ";
  let o = {
  ...
  for (let s of o.features) {
    ...
    (e.className = "marker"),
      e.insertAdjacentHTML(
        ...
        '<img src="' +
          assetsPath +
          '../images/fleet-car.png" alt="Fleet Car" width="20" class="rounded-3" id="carFleet-' +
    ...
    t.addEventListener("click", function () {
      ...
      Helpers._hasClass("active", t)
        ? (a.flyTo({
            center: o.features[s.properties.message - 1].geometry.coordinates,
            zoom: 16,
          }),
          e && Helpers._removeClass("marker-focus", e),
          Helpers._addClass("marker-focus", r))
        : Helpers._removeClass("marker-focus", r);
    });
  }
  ...
  Helpers._addClass("marker-focus", t),
    ...
    (t = $(".logistics-fleet-sidebar-body")).length &&
      new PerfectScrollbar(t[0], { wheelPropagation: !1, suppressScrollX: !0 });
})();
